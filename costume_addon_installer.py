...
for mass_addon in batch_proccess_list:
    ...
    if chara_id == 1:
        print(f'Adding {costume_name_en} to Honoka Kousaka')
    elif chara_id == 2:
        print(f'Adding {costume_name_en} to Eli Ayase')
    elif chara_id == 3:
        print(f'Adding {costume_name_en} to Kotori Minami')
    elif chara_id == 4:
        print(f'Adding {costume_name_en} to Umi Sonoda')
    elif chara_id == 5:
        print(f'Adding {costume_name_en} to Rin Hoshizora')
    elif chara_id == 6:
        print(f'Adding {costume_name_en} to Maki Nishikino')
    elif chara_id == 7:
        print(f'Adding {costume_name_en} to Nozomi Tojo')
    elif chara_id == 8:
        print(f'Adding {costume_name_en} to Hanayo Koizumi')
    elif chara_id == 9:
        print(f'Adding {costume_name_en} to Nico Yazawa')
    elif chara_id == 101:
        print(f'Adding {costume_name_en} to Chika Takami')
    elif chara_id == 102:
        print(f'Adding {costume_name_en} to Riko Sakurauchi')
    elif chara_id == 103:
        print(f'Adding {costume_name_en} to Kanan Matsuura')
    elif chara_id == 104:
        print(f'Adding {costume_name_en} to Dia Kurosawa')
    elif chara_id == 105:
        print(f'Adding {costume_name_en} to You Watanabe')
    elif chara_id == 106:
        print(f'Adding {costume_name_en} to Yoshiko Tsushima')
    elif chara_id == 107:
        print(f'Adding {costume_name_en} to Hanamaru Kunikida')
    elif chara_id == 108:
        print(f'Adding {costume_name_en} to Mari Ohara')
    elif chara_id == 109:
        print(f'Adding {costume_name_en} to Ruby Kurosawa')
    elif chara_id == 201:
        print(f'Adding {costume_name_en} to Ayumu Uehara')
    elif chara_id == 202:
        print(f'Adding {costume_name_en} to Kasumi Nakasu')
    elif chara_id == 203:
        print(f'Adding {costume_name_en} to Shizuku Osaka')
    elif chara_id == 204:
        print(f'Adding {costume_name_en} to Karin Asaka')
    elif chara_id == 205:
        print(f'Adding {costume_name_en} to Ai Miyashita')
    elif chara_id == 206:
        print(f'Adding {costume_name_en} to Kanata Konoe')
    elif chara_id == 207:
        print(f'Adding {costume_name_en} to Setsuna Yuki')
    elif chara_id == 208:
        print(f'Adding {costume_name_en} to Emma Verde')
    elif chara_id == 209:
        print(f'Adding {costume_name_en} to Rina Tennoji')
    elif chara_id == 210:
        print(f'Adding {costume_name_en} to Shioriko Mifune')
    elif chara_id == 212:
        print(f'Adding {costume_name_en} to Lanzhu Zhong')
    elif chara_id == 211:
