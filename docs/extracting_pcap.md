...
*This is considered [advanced usage](https://github.com/tagundo/elichika/blob/master/docs/advanced_usage.md): you should know what pcap is and you need to have a generated pcap from before EOS to do this with.*
