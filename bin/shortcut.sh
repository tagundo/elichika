...
chmod +x ~/fast_update_elichika2 && \
echo "Use \"~/run_elichika2\" in termux to run the server!" && \
echo "Use \"~/menu_elichika2\" in termux to run the menu!" && \
echo "Use \"~/fast_update_elichika2\" in termux to update the server!"
echo "Use \"~/update_elichika2\" in termux to update the server using basic logic (will be slower but will work even if you have a really old version)!"
